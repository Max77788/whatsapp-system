  ...
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
        ...
        <div className="flex justify-center w-full"><a href={`/${currentLocale}/plans`} className="inline-flex items-center justify-center px-1 py-1 text-xl font-medium text-white underline rounded-full transition-colors duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 gap-2 hover:text-white">{t('viewPlans')}</a></div>
      </main>
